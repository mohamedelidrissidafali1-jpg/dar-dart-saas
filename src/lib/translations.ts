...
const t = {
  en: {
    ...
    survey: {
      ...
      submitAndWhatsapp: "Submit & Send via WhatsApp",
      thankYou: "Thank you,",
...
**Address:** 19 Derb Zemrane, Marrakech Medina 40000, Morocco`,
  ...
  fr: {
    ...
    survey: {
      ...
      submitAndWhatsapp: "Soumettre et envoyer via WhatsApp",
      thankYou: "Merci,",
...
**Adresse :** 19 Derb Zemrane, Médina de Marrakech 40000, Maroc`,
  ...
  es: {
    ...
    survey: {
      ...
      submitAndWhatsapp: "Enviar via WhatsApp",
      thankYou: "¡Gracias,",
...
**Dirección:** 19 Derb Zemrane, Medina de Marrakech 40000, Marruecos`,
  ...
  ar: {
    ...
    survey: {
      ...
      submitAndWhatsapp: "إرسال عبر واتساب",
      thankYou: "شكراً،",
...
**العنوان:** 19 درب زمران، المدينة القديمة، مراكش 40000، المغرب`,
  ...
  de: {
    ...
    survey: {
      ...
      submitAndWhatsapp: "Absenden und über WhatsApp senden",
      thankYou: "Danke,",
...
**Adresse:** 19 Derb Zemrane, Medina Marrakesch 40000, Marokko`,
  ...
  it: {
    ...
    survey: {
      ...
      submitAndWhatsapp: "Invia tramite WhatsApp",
      thankYou: "Grazie,",
