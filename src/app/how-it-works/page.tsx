...
const BENEFIT_ICONS = [
  (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-7 h-7" key="clock">
      <path d="M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm.5-13H11v6l5.25 3.15.75-1.23-4.5-2.67V7z" />
    </svg>
  ),
  (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-7 h-7" key="lang">
      <path d="M12.87 15.07l-2.54-2.51.03-.03A17.52 17.52 0 0014.07 6H17V4h-7V2H8v2H1v2h11.17C11.5 7.92 10.44 9.75 9 11.35 8.07 10.32 7.3 9.19 6.69 8h-2c.73 1.63 1.73 3.17 2.98 4.56l-5.09 5.02L4 19l5-5 3.11 3.11.76-2.04zM18.5 10h-2L12 22h2l1.12-3h4.75L21 22h2l-4.5-12zm-2.62 7l1.62-4.33L19.12 17h-3.24z" />
    </svg>
  ),
  (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-7 h-7" key="check">
...
export default function HowItWorks() {
  ...
  const steps = tr.howItWorksPage.steps as { title: string; desc: string }[];
  const benefits = tr.howItWorksPage.benefits as { title: string; desc: string }[];
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            ...
            <h2
              ...
              style={{ color: "var(--ink)", letterSpacing: "0.05em" }}
            >
              {tr.howItWorksPage.aSmarterStay}
            </h2>
            <Divider />
          </div>
